...
class ArtistQuestionScreen extends React.PureComponent {
  render() {
    const {question, handlerAnswerClick, handlerPlayClick, handlerSubmit} = this.props;
    return (
            ...
            {question.answers.map((answer, index) => {
              return (
                <div key={index} className="artist">
                  <input className="artist__input visually-hidden" type="radio" name="answer" value={answer.artist} id={`answer-` + index} onClick={handlerAnswerClick} />
